...
return (
    <Pane>
      <Pane>
        <Text><FormattedMessage id="itemsInCart" /> {cartQuantity}</Text>
      </Pane>
      <Pane>
        <Text><FormattedMessage id="cartTotal" /> ${cartTotal}</Text>
      </Pane>
      <Pane paddingTop={10} >
        ...
        <div className={`container ${showMenu ? "is-open" : ""}`}>
          ...
          <div className="container__sidebar">
            <div className="sidebar">
              ...
              <Link to="/"><RenderLogo color="#0f0"/></Link>
